...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, cls_num=4, leaky_relu=False, leaky_scale=0, **kwargs):
      ...
      #                         bias=False)
        ...
        self.border_labels = [c for c in combinations(range(cls_num), 2)]
        self.out_cls_num = cls_num + len(self.border_labels)

        # 1x1 conv can be replaced with more light-weight bn layer
        self.BNH = nn.BatchNorm1d(128)
